...
class MainWindow(QMainWindow):
    ...
    def _setup_tts_tab(self):
        ...
        self.tts_text_edit.setPlaceholderText(
            ...
            "Инструкции в скобках (влияют на тон следующего фрагмента):\n"
            "  [смеётся] [хохочет] [шёпотом] [шепч] [кричит] [громко] [тихо]\n"
            "  [грустно] [радостно] [сердито] [удивлённо] [плачет] [вздыхает]\n"
            "  [пауза] — 0.5с  |  [длинная_пауза] — 1.0с\n"
            "\n"
